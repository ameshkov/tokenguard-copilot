...
/** Sample content rules for the mock API. Exercises the full
 *  schema: different roles, message numbers, model patterns,
 *  tool presence/absence, regex flags. */
export const sampleContentRules: ContentRuleInfo[] = [
  {
    id: 'rule-001',
    name: 'Strip built-in skills from system prompt',
    enabled: true,
    matchRole: 'system',
  ...
  {
    id: 'rule-002',
    name: 'Remove memory instructions when tool absent',
    enabled: true,
    matchRole: 'system',
    matchMessageNumber: null,
    matchModelPattern: null,
  ...
  {
    id: 'rule-003',
    name: 'Add prefix to first user message for Claude',
    enabled: true,
    matchRole: 'user',
    matchMessageNumber: 1,
    matchModelPattern: 'claude-*',
    matchContentPattern: null,
    matchToolPresent: null,
    matchToolAbsent: null,
    regexPattern: '^',
  ...
  {
    id: 'rule-004',
    name: '[DISABLED] Normalize role names',
    enabled: false,
    matchRole: 'all',
    matchMessageNumber: null,
    matchModelPattern: null,
  ...
  {
    id: 'rule-005',
    name: 'Inject model hint when both tools available',
    enabled: true,
    matchRole: 'system',
    matchMessageNumber: null,
    matchModelPattern: 'gpt-*',
    matchContentPattern: null,
    matchToolPresent: ['read_file', 'memory'],
    matchToolAbsent: null,
    regexPattern: '(?=You are a)',
    regexFlags: '',
    substitution: 'You have access to codebase files and persistent memory. ',
    sortOrder: 4,
